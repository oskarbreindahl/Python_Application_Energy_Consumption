...
The benchmarks are invoked 10 times per version of \python on each of the four \gls{os}, \projname{FreeBSD}, \projname{Alpine}, \projname{Manjaro}, and \projname{Ubuntu} Linux, see outer most loop in \autoref{fig:scenario}, and in turn on each of the two \gls{sut} (\toolname{Raspberry Pi 3B+} and \toolname{4B} respectively.
